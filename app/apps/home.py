...
def app():
    ...
    components.html(
        ...
        <div class="card-body">
            ...
            <p class="card-text">Examining Real Estate using different vizualisation techniques. <br>
            By using the slider on the left you can view different slices of time and explore different trends.</p>
        </div>
        </div>
        """,
    ...
    st.markdown(     
        ...
        <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
        <br>
        <a href="https://www.data.gouv.fr/fr/datasets/demandes-de-valeurs-foncieres/" class="btn btn-primary text-white" target="_blank">Source dataset can be found here.</a>
        """ ,
